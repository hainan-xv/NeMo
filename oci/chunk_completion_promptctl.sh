...
#SBATCH -J nemotron_speechprod_asr:streaming-stt-chunkcompletion-promptctl
...
#   recipe:     /code/examples/speechlm2/conf/streaming_stt_granary2_lora_chunkcompletion_promptctl.yaml
#
...
#   sbatch oci/chunk_completion_promptctl.sh          # seed 42
#   sbatch oci/chunk_completion_promptctl.sh 123      # seed 123
# ============================================================================
...
CONFIG_NAME=streaming_stt_granary2_lora_chunkcompletion_promptctl
...
echo "*******STARTING********" \
&& echo "---------------" \
&& echo "*** RECIPE: ${CONFIG_NAME} (chunk-completion, EXACT-delay + TEXT-repr prompt control, granary2, no-blank) ***" \
