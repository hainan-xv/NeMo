...
#SBATCH -J nemotron_speechprod_asr:streaming-stt-chunkcompletion-promptctl-d8
...
#   recipe:     /code/examples/speechlm2/conf/streaming_stt_granary2_lora_chunkcompletion_promptctl_d8.yaml
#   (max-delay-8 variant: exact_max_delay=8, i.e. delay ~ Uniform[0, 8] frames.)
#
...
#   sbatch oci/chunk_completion_promptctl_d8.sh          # seed 42
#   sbatch oci/chunk_completion_promptctl_d8.sh 123      # seed 123
# ============================================================================
...
CONFIG_NAME=streaming_stt_granary2_lora_chunkcompletion_promptctl_d8
...
echo "*******STARTING********" \
&& echo "---------------" \
&& echo "*** RECIPE: ${CONFIG_NAME} (chunk-completion, EXACT-delay[0..8] + TEXT-repr prompt control, granary2, no-blank) ***" \
