...
#SBATCH -J nemotron_speechprod_asr:streaming-stt-g2-nb-2stream
...
#   sbatch oci/streaming_stt_finetune_granary2_noblank_wer_twostream.sh          # seed 42
#   sbatch oci/streaming_stt_finetune_granary2_noblank_wer_twostream.sh 123      # seed 123
# ============================================================================
...
EXP_NAME=granary2_noblank_wer_twostream
...
&& echo "*** EXPERIMENT: two_stream_last_layer=true (audio fused only in final layer); LoRA all layers; encoder trainable ***" \
