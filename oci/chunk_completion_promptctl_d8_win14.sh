...
#SBATCH -J nemotron_speechprod_asr:streaming-stt-chunkcompletion-promptctl-d8-win14
...
#   recipe:     /code/examples/speechlm2/conf/streaming_stt_granary2_lora_chunkcompletion_promptctl_d8_win14.yaml
#   (max-delay-8 + FIXED 14-frame audio window: exact_max_delay=8, audio_window_frames=14;
#    every branch conditions on the last 14 encoder frames regardless of chunk size.
#    chunk_size list capped at 14 so the window is uniformly 14.)
#
...
#   sbatch oci/chunk_completion_promptctl_d8_win14.sh          # seed 42
#   sbatch oci/chunk_completion_promptctl_d8_win14.sh 123      # seed 123
# ============================================================================
...
CONFIG_NAME=streaming_stt_granary2_lora_chunkcompletion_promptctl_d8_win14

EXP_NAME=granary2_chunkcompletion_promptctl_d8_win14
...
echo "*******STARTING********" \
&& echo "---------------" \
&& echo "*** RECIPE: ${CONFIG_NAME} (chunk-completion, EXACT-delay[0..8] + TEXT-repr + FIXED 14-frame audio window, granary2, no-blank) ***" \
