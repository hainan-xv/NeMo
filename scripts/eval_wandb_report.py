...
Backend-agnostic: both pooled-shard aggregators
(``scripts/leaderboard_heh_shards.py aggregate`` and
``scripts/speechlm_leaderboard_eval.py --aggregate``) print the SAME
