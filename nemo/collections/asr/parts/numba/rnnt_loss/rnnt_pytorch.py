...
__all__ = ['rnnt_loss', 'RNNTLossNumba', 'MultiblankRNNTLossNumba', 'TDTLossNumba', 'WordawareTDTLossNumba']
...
class _WordawareTDTNumba(Function):
    """
    ...
    def forward(
        ...
        if is_cuda:
            loss_func = rnnt.wordaware_tdt_loss_gpu
        else:
