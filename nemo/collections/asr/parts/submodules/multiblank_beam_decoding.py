...
from nemo.collections.asr.parts.submodules.rnnt_beam_decoding import pack_hypotheses, _states_to_device

class BeamMultiblankInfer(Typing):
    """
    ...
    def __init__(
        ...
        print("HERE blank is", self.blank)
        self.big_blank_durations = big_blank_durations
        if len(big_blank_durations) < 1:
            raise ValueError("big_blank_durations is empty")
