...
#SBATCH -J nemotron_speechprod_asr:streaming-stt-chat-asr-recov
...
#
#   sbatch launch/chat_train_win28_recover.sh        # no arguments, no env vars
#   ./oci_launch.sh launch/chat_train_win28_recover.sh
#
...
export CONFIG_NAME=streaming_stt_granary2_chat_asrvocab_win28_recover
...
export EXP_NAME="${EXP_NAME:-granary2_chat_asrvocab_win28_recover}"
