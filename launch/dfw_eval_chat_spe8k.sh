...
#SBATCH -J nemotron_speechprod_asr:dfw-eval-chat-spe8k
...
# ============================================================================
# Open-ASR-Leaderboard eval of the 8k purpose-built-vocabulary CHAT arm.
#
#   sbatch launch/dfw_eval_chat_spe8k.sh
#
...
# the Qwen path it would build a 151.7k-piece output layer for a 8k checkpoint.
set -euo pipefail
...
export ARM_EXP_NAME=dfw_granary2_chat_spe8k_both
