...
#SBATCH -J nemotron_speechprod_asr:oci-off-script-multi-cs7
...
#
#   sbatch launch/oci_eval_official_script_multi_cs7.sh
#
# SCRIPT multi-lookahead, decoded at CHUNK SIZE 7 -- half the lookahead of cs14,
# from the SAME checkpoint. See oci_eval_official_script_multi_cs14.sh.
#
