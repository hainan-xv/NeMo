...
#SBATCH -J nemotron_speechprod_asr:eval-script-both-cs14
...
# ============================================================================
# Leaderboard eval: granary2_script_banded1_both @ chunk 14
#
#   sbatch launch/oci_eval_script_banded1_both.sh
#
# The single-chunk banded-both arm. Chunk 14 is the size it trains at.
# ============================================================================
set -euo pipefail
mkdir -p slurm_out
