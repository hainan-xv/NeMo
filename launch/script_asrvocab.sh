...
#SBATCH -J nemotron_speechprod_asr:streaming-stt-script-asrvocab
...
CONFIG_NAME="${CONFIG_NAME:-streaming_stt_granary2_lora_script_asrvocab}"
EXP_NAME="${EXP_NAME:-granary2_script_asrvocab}"
