...
#SBATCH -J nemotron_speechprod_asr:streaming-stt-script-readwrite
...
#   sbatch launch/script_readwrite.sh         # seed 42
#   sbatch launch/script_readwrite.sh 123     # seed 123
#
# Or from your laptop:
#   ./oci_launch.sh launch/script_readwrite.sh
#   ./oci_launch_interactive.sh MAX_STEPS=50 VAL_CHECK_INTERVAL=25 launch/script_readwrite.sh
#
# Knobs (env overrides):
...
EXP_NAME="${EXP_NAME:-granary2_script_readwrite}"
