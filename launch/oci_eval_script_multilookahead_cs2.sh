...
#SBATCH -J nemotron_speechprod_asr:eval-script-multi-cs2
...
# ============================================================================
# Leaderboard eval: granary2_script_banded1_both_multilookahead @ chunk 2
#
#   sbatch launch/oci_eval_script_multilookahead_cs2.sh
#
# Multi-look-ahead arm decoded at chunk 2 (~0.16 s look-ahead).
# One eval per chunk size: the arm samples chunk_size per BATCH during
# training, but a decode has to commit to one, and the whole point is the
# latency/accuracy curve across them.
# ============================================================================
set -euo pipefail
mkdir -p slurm_out
...
export EVAL_TAG="${EVAL_TAG:-granary2_script_banded1_both_multilookahead_cs2}"
...
exec bash "$(find_launch_dir)/eval_script.sh" granary2_script_banded1_both_multilookahead 2
