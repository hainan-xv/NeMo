...
#SBATCH -J nemotron_speechprod_asr:dfw-chat-spe2k-both
#SBATCH -p batch
#SBATCH -N 2
...
# CHAT band-1 both-side with a PURPOSE-BUILT 2k SentencePiece vocabulary.
#
...
#
# NOTE FOR EVAL: a smaller vocabulary means MORE tokens per word (2048-piece
# needs ~20 tokens on a probe sentence vs 13 at 16k), hence more inner
...
export EXP_NAME="${EXP_NAME:-dfw_granary2_chat_spe2k_both}"
...
# vocabulary -- so with a 2k SentencePiece vocabulary they cannot transfer
...
export TOKENIZER_DIR="${DFW}/hainanx/tokenizers/granary2_en_spe/v2048"
