...
#SBATCH -J nemotron_speechprod_asr:oci-off-script-delay3-cs14
...
exec bash "$(resolve_launch_dir)/oci_eval_official_backend.sh" \
    script_delay3_cs14 \
    "${MY}/results/SpeechlmOCI/granary2_script_banded1_both_multilookahead_delay3/granary2_script_banded1_both_multilookahead_delay3/checkpoints/granary2_script_banded1_both_multilookahead_delay3-averaged.ckpt" \
    0.5 0 14
