...
#SBATCH -J nemotron_speechprod_asr:dfw-corrector-long
...
#
# ONE node, its own EXP_NAME. Deliberately not the real multi-node run:
...
EXP_NAME="${EXP_NAME:-dfw_corrector_long}"
