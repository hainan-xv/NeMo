...
#SBATCH -J nemotron_speechprod_asr:dfw-chat-spe8k-both
#SBATCH -p batch
#SBATCH -N 2
...
# CHAT band-1 both-side with a PURPOSE-BUILT 8k SentencePiece vocabulary.
#
...
export EXP_NAME="${EXP_NAME:-dfw_granary2_chat_spe8k_both}"
...
# vocabulary -- so with a 8k SentencePiece vocabulary they cannot transfer
