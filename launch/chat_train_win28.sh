...
#SBATCH -J nemotron_speechprod_asr:streaming-stt-chat-asr-win28
...
#
#   sbatch launch/chat_train_win28.sh        # no arguments, no env vars
#   ./oci_launch.sh launch/chat_train_win28.sh
#
...
export CONFIG_NAME=streaming_stt_granary2_chat_asrvocab_win28
...
export EXP_NAME="${EXP_NAME:-granary2_chat_asrvocab_win28}"
