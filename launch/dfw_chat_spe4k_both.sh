...
#SBATCH -J nemotron_speechprod_asr:dfw-chat-spe4k-both
#SBATCH -p batch
#SBATCH -N 2
...
# CHAT band-1 both-side with a PURPOSE-BUILT 4k SentencePiece vocabulary.
#
...
#
# NOTE FOR EVAL: a smaller vocabulary means MORE tokens per word (4096-piece
# needs ~19 tokens on a probe sentence vs 13 at 16k), hence more inner
...
export EXP_NAME="${EXP_NAME:-dfw_granary2_chat_spe4k_both}"
...
# vocabulary -- so with a 4k SentencePiece vocabulary they cannot transfer
...
export TOKENIZER_DIR="${DFW}/hainanx/tokenizers/granary2_en_spe/v4096"
