...
#SBATCH -J nemotron_speechprod_asr:dfw-eval-chat-spe8kbb
...
export ARM_EXP_NAME=dfw_granary2_chat_spe8k_both_bigbatch
export ARM_CONFIG_NAME=nemotron_chat_transducer_granary2_spe
export ARM_TOKENIZER_DIR="${DFW}/hainanx/tokenizers/granary2_en_spe/v8192"
