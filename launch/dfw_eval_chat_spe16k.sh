...
#SBATCH -J nemotron_speechprod_asr:dfw-eval-chat-spe16k
...
# ============================================================================
# Open-ASR-Leaderboard eval of the 16k purpose-built-vocabulary CHAT arm.
#
#   sbatch launch/dfw_eval_chat_spe16k.sh
#
...
# the Qwen path it would build a 151.7k-piece output layer for a 16k checkpoint.
set -euo pipefail
...
export ARM_EXP_NAME=dfw_granary2_chat_spe16k_both
export ARM_CONFIG_NAME=nemotron_chat_transducer_granary2_spe
export ARM_TOKENIZER_DIR="${DFW}/hainanx/tokenizers/granary2_en_spe/v16384"
