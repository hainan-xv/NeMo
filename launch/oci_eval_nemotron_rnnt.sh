...
#SBATCH -J nemotron_speechprod_asr:oci-eval-nemotron-rnnt
...
# ============================================================================
# Reference-model eval: nvidia/nemotron-speech-streaming-en-0.6b (RNN-T)
#
#   sbatch launch/oci_eval_nemotron_rnnt.sh
#
# The streaming RNN-T reference, and the encoder donor the CHAT arms warm-start
# from. pad 0.5 because it is a STREAMING model trained with trailing-silence
# padding, matching how the streaming arms are evaluated.
#
...
export MODEL_PATH="${MODEL_PATH:-/lustre/fsw/portfolios/llmservice/users/heh/pretrained_models/huggingface/nvidia/nemotron-speech-streaming-en-0.6b/nemotron-speech-streaming-en-0.6b.nemo}"
export EXP_NAME="${EXP_NAME:-nemotron_streaming_0.6b_baseline}"
export MODE="${MODE:-offline}"
export CHUNK_SIZE="${CHUNK_SIZE:-14}"
export PAD_EXTRA_SECONDS="${PAD_EXTRA_SECONDS:-0.5}"
