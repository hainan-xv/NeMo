...
#SBATCH -J nemotron_speechprod_asr:oci-off-speechlm-cs2
...
#
# CHUNK SIZE 2, the lowest-latency operating point, from the same checkpoint.
#
# IN DISTRIBUTION: trained on chunk_size {2,4,7,10,14,28}. Our SCRIPT arm fell
# off a cliff here (9.184 macro against 5.554 at cs14), so this row is the one
# that tests whether the interleaved layout degrades as sharply at minimum
# lookahead -- the most interesting cell in the whole comparison.
# ============================================================================
set -uo pipefail
mkdir -p slurm_out
