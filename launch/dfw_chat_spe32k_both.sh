...
#SBATCH -J nemotron_speechprod_asr:dfw-chat-spe32k-both
#SBATCH -p batch
#SBATCH -N 2
...
# CHAT band-1 both-side with a PURPOSE-BUILT 32k SentencePiece vocabulary.
#
# One of three arms (8k/16k/32k) that replace Qwen3's 151.7k multilingual LLM
...
export EXP_NAME="${EXP_NAME:-dfw_granary2_chat_spe32k_both}"
...
# vocabulary -- so with a 32k SentencePiece vocabulary they cannot transfer
...
export TOKENIZER_DIR="${DFW}/hainanx/tokenizers/granary2_en_spe/v32768"
