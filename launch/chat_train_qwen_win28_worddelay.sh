...
#SBATCH -J nemotron_speechprod_asr:streaming-stt-chat-qwen-wdelay
...
#
#   sbatch launch/chat_train_qwen_win28_worddelay.sh        # no arguments, no env vars
#   ./oci_launch.sh launch/chat_train_qwen_win28_worddelay.sh
#
...
export CONFIG_NAME=streaming_stt_granary2_chat_qwenvocab_win28_worddelay
...
export EXP_NAME="${EXP_NAME:-granary2_chat_qwenvocab_win28_worddelay}"
