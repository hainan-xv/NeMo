...
#SBATCH -J nemotron_speechprod_asr:eval-chat-flexdelay
...
# ============================================================================
# Leaderboard eval -- CHAT with flexible delay d ~ U{0..4}, decoded at d = 2.
#
#   sbatch launch/eval_chat_flexdelay.sh          <- no arguments, no environment to set
#
...
export ARM_EXP_NAME=granary2_chat_forced_asrvocab_flexdelay4
export ARM_MODEL_OVERRIDES="model.loss_type=forced_alignment model.forced_alignment.num_delay_frames=0 model.forced_alignment.recover_history_words=0 model.forced_alignment.max_delay_frames=4 model.joint.history_chunks=1"
export TOPK=5
