...
#SBATCH -J nemotron_speechprod_asr:dfw-script-banded1-nodelay-v2
...
EXP_NAME="${EXP_NAME:-dfw_granary2_script_banded1_nodelay_v2}"
...
# Measured on the v1 arms: 37.3-45.6 GiB of 81.5 GiB per GPU, i.e. 56%
...
#
# The target is deliberately under 39.6: 36 audio-s, leaving margin because
...
# v1 arms was 22% at identical nominal batch, which is that effect.
#
...
# applies.
BUCKET_BATCH_SIZE="${BUCKET_BATCH_SIZE:-[8,6,5,4,4,3,3,3,3,2,2,2,2,1,1,1,1,1]}"
#
