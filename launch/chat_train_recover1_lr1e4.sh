...
#SBATCH -J nemotron_speechprod_asr:chat-recover1-lr1e4
...
#
#   sbatch launch/chat_train_recover1_lr1e4.sh          <- no arguments, no environment to set
#
...
export EXP_NAME="${EXP_NAME:-granary2_chat_forced_asrvocab_win28_recover1_delay0_lr1e4}"
