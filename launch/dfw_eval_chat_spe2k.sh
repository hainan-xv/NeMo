...
#SBATCH -J nemotron_speechprod_asr:dfw-eval-chat-spe2k
...
# ============================================================================
# Open-ASR-Leaderboard eval of the 2k purpose-built-vocabulary CHAT arm.
#
#   sbatch launch/dfw_eval_chat_spe2k.sh
#
...
# the Qwen path it would build a 151.7k-piece output layer for a 2k checkpoint.
set -euo pipefail
...
export ARM_EXP_NAME=dfw_granary2_chat_spe2k_both
export ARM_CONFIG_NAME=nemotron_chat_transducer_granary2_spe
export ARM_TOKENIZER_DIR="${DFW}/hainanx/tokenizers/granary2_en_spe/v2048"
