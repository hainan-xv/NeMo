...
#SBATCH -J nemotron_speechprod_asr:chat-banded-qwen-win28-lr1e4
...
#
#   sbatch launch/chat_train_banded_qwen_win28_lr1e4.sh    <- no arguments
#
...
export EXP_NAME="${EXP_NAME:-granary2_chat_banded1_qwenvocab_win28_lr1e4}"
